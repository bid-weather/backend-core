...
WHERE subcategory_id IS NULL AND (
    title LIKE '%가뭄%' OR
    title LIKE '%농업용수%' OR title LIKE '%공업용수%' OR title LIKE '%생활용수%' OR
    title LIKE '%저수지%' OR title LIKE '%취수%' OR
    title LIKE '%긴급급수%' OR title LIKE '%제한급수%' OR
    title LIKE '%물부족%' OR title LIKE '%관개%' OR
    title LIKE '%수리시설%' OR title LIKE '%양수%'
    );
...
WHERE subcategory_id IS NULL AND (
    ...
    title LIKE '%절개지%' OR
    title LIKE '%토사%' OR title LIKE '%산사태%' OR title LIKE '%급경사%' OR
...
WHERE subcategory_id IS NULL AND (
    title LIKE '%산불%' OR
    title LIKE '%수목관리%' OR title LIKE '%수목제거%' OR title LIKE '%수목전지%' OR
    title LIKE '%벌목%' OR title LIKE '%방화선%' OR title LIKE '%임도%' OR
    title LIKE '%숲가꾸%' OR title LIKE '%가로수%' OR title LIKE '%산림%'
    );
...
WHERE subcategory_id IS NULL AND (
    ...
    title LIKE '%보건%' OR title LIKE '%검역%' OR title LIKE '%방충%' OR
    title LIKE '%해충%' OR title LIKE '%위생%' OR title LIKE '%역병%'
    );
